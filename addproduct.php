...
if(isset($_POST['product_submit'])) {
    ...
    $sql = "INSERT INTO product(product_name, category, description, price) VALUES('$product_name','$category','$description','$price')";
                    ...
                    <div class="container-fluid">
                        ...
                        <form  action="" method = "post">
                            <div class="form-row">
                                ...
                                <input type="name" class="form-control" name="product_name" id="product" placeholder="Product">
                                </div>
                                <div class="form-group col-md-6">
                                <label for="category">Category</label>
                                <input type="name" class="form-control" name="category"id="category" placeholder="Category">
                                </div>
                            </div>
